#!/bin/bash 
if [ -e bochs-2.6.10 ];then
	/usr/bin/rm -rf bochs-2.6.10
	echo "============================================================"
	echo -e "\e[32m\e[1m\e[1m clean env \e[0m"
	echo "============================================================"
fi

if [ -e bochs-2.6.10.tar.gz ];then
	echo "============================================================"
	echo -e "\e[32m\e[1m\e[1m find bochs-2.6.10.tar.bz2,unpacking it... \e[0m"
	echo "============================================================"
	tar -xvf bochs-2.6.10.tar.gz 
else
	echo "============================================================"
	echo -e "\e[31m\e[1m\e[1m error!no bochs-2.6.10.tar.bz2 found!\e[0m"
	echo "============================================================"
	exit 1
fi


cd bochs-2.6.10 && ./configure --with-x11 --with-wx --enable-debugger --enable-disasm \
...
if [ $? -ne 0 ];then 
	...
	echo "============================================================"
	echo -e "\e[32m\e[1m\e[1m configure bochs-2.6.10 success!!compiling it \e[0m"
	echo "============================================================"
...
if [ $? -eq 0 ];then
	echo "============================================================"
	echo -e "\e[32m\e[1m\e[1m successful installed bochs-2.6.10! \e[0m"
	echo "============================================================"
	cd .. && /usr/bin/rm -rf bochs-2.6.10
	echo -e "\e[32m\e[1m\e[1m clean dir bochs-2.6.10"
	echo "============================================================"
